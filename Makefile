...
#
# this uses unsigned char instead of char because char may be signed, and utf8 Ö doesn't fit in signed chars
src/builtinscode.h:
	( \
		echo '// this file was generated by the Makefile'; \
		echo '#ifndef BUILTINSCODE_H'; \
		echo '#define BUILTINSCODE_H'; \
		echo 'const unsigned char builtinscode[] = {'; \
		xxd -i < src/builtins.ö; \
		echo '};'; \
		echo '#endif'; \
	) > src/builtinscode.h
