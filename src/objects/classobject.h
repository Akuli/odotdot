...
// TODO: move these somewhere else?? these aren't really related to just classobjects
struct Object *classobject_getmethod(struct Interpreter *interp, struct Object **errptr, struct Object *obj, char *name);
struct Object *classobject_getmethod_ustr(struct Interpreter *interp, struct Object **errptr, struct Object *obj, struct UnicodeString name);
